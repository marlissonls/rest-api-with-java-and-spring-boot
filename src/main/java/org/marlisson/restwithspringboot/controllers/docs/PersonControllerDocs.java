package org.marlisson.restwithspringboot.controllers.docs;
...
public interface PersonControllerDocs {
    ...
    // ResponseEntity<Page<PersonDTO>> findAll( -> Assim o HATEOAS não funciona para os dados de paginação.
    ...
    @Operation(summary = "Massive Peolple Creation",
    ...
    @Operation(summary = "Export Person data as PDF",
            description = "Export a specific Person's data as a PDF by ID",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "Disable a Person",
            description = "Disable a specific person by its ID",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
